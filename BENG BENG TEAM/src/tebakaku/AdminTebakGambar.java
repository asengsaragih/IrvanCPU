 ...
 * @author Layat
 */
public class AdminTebakGambar extends javax.swing.JFrame {

    /**
     * Creates new form AdminTebakGambar
     */
    private Connection connection;
    public AdminTebakGambar() {
        initComponents();
        // Koneksi ke database
    ...
    private void initComponents() {
        ...
        btnTebakGambar.setBackground(new java.awt.Color(102, 153, 255));
        ...
        tabelTebakGambar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "No", "ID Quiz", "Link Soal Quiz", "Jawaban Quiz", "Pilihan Jawaban"
            }
        ));
        tabelTebakGambar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelTebakGambarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelTebakGambar);
        ...
        btnCariGambar.setBackground(new java.awt.Color(102, 153, 255));
        btnCariGambar.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        btnCariGambar.setForeground(new java.awt.Color(255, 255, 255));
        btnCariGambar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnCariGambar.setText("Browse");
        btnCariGambar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnCariGambar.setOpaque(true);
        btnCariGambar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnCariGambarMouseClicked(evt);
            }
        });

        gambarSoal.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gambarSoal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(inputSoalQuiz, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(btnCariGambar, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(17, 17, 17)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(inputJawabanQuiz, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
                                .addComponent(gambarSoal, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)))
                        .addGap(49, 49, 49))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnCariGambar, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(5, 5, 5)
                        .addComponent(gambarSoal, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void tampilTebakGambar(){
        DefaultTableModel model = new DefaultTableModel();
        model.addColumn("No");
        model.addColumn("ID Quiz");
        model.addColumn("Link Soal Quiz");
        model.addColumn("Jawaban Quiz");
        model.addColumn("Pilihan Jawaban Quiz");
        int nomor = 1;
        try{
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery("SELECT * FROM quiz_tebak_gambar");
            ...
            tabelTebakGambar.setModel(model);
        }catch(Exception e){
    ...
    private void btnSimpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSimpanMouseClicked
        ...
        String namaFile = inputSoalQuiz.getText();
        String[] tempNamaFile = namaFile.split("\\\\");
        ArrayList<String> teksLengkap = new ArrayList<String>();
        String teksJadi = "";
        for (int i = 0; i < tempNamaFile.length; i++) {
            teksLengkap.add(tempNamaFile[i].trim());
        }
        for (int i = 0; i < tempNamaFile.length; i++) {
            teksJadi = teksJadi+teksLengkap.get(i)+"\\\\\\\\";
        }
        if(namaFile.equals("") || jawabanQuiz.equals("") || pilihanJawaban.equals("")){
            JOptionPane.showMessageDialog(this, "Form tidak boleh kosong");
        }else{
            try{
                Statement statement = connection.createStatement();
                statement.execute("INSERT INTO quiz_tebak_gambar (soal_quiz,jawaban_quiz,pilihan_quiz) VALUES ('"+teksJadi+"','"+jawabanQuiz+"','"+pilihanJawaban+"')");
    ...
    private void btnUbahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUbahMouseClicked
        ...
        try{
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
                Statement statement = connection.createStatement();
                statement.execute("UPDATE quiz_tebak_gambar SET soal_quiz = '"+teksJadi+"', jawaban_quiz = '"+jawabanQuiz+"', pilihan_quiz = '"+pilihanJawaban+"' WHERE id_quiz = '"+idQuiz+"'");
    ...
    private void btnHapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHapusMouseClicked
        ...
        try{
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
                ...
                Statement statement = connection.createStatement();
                statement.execute("DELETE FROM quiz_tebak_gambar WHERE id_quiz = '"+idQuiz+"'");
            }
            tampilTebakGambar();
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, e);
    ...
    private void tabelTebakGambarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelTebakGambarMouseClicked
        // TODO add your handling code here:
        int baris = tabelTebakGambar.rowAtPoint(evt.getPoint());
        String idQuiz = tabelTebakGambar.getValueAt(baris,1).toString();
        getIdQuiz.setText(idQuiz);
        String soalQuiz = tabelTebakGambar.getValueAt(baris,2).toString();
        inputSoalQuiz.setText(soalQuiz);
        // Tampil Gambar
        ImageIcon imageIcon = new ImageIcon(inputSoalQuiz.getText());
        ...
        String jawabanQuiz = tabelTebakGambar.getValueAt(baris,3).toString();
        inputJawabanQuiz.setText(jawabanQuiz);
        String pilihanJawaban = tabelTebakGambar.getValueAt(baris,4).toString();
        inputPilihanJawaban.setText(pilihanJawaban);
    }//GEN-LAST:event_tabelTebakGambarMouseClicked
    ...
    private void btnCariGambarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariGambarMouseClicked
        // TODO add your handling code here:
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.showOpenDialog(null);
        File file = fileChooser.getSelectedFile();
        String fileName = file.getAbsolutePath();
        inputSoalQuiz.setText(fileName);
        ImageIcon imageIcon = new ImageIcon(fileName);
        Image settings = imageIcon.getImage();
        Image imageScaled = settings.getScaledInstance(gambarSoal.getWidth(), gambarSoal.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon settingsImage = new ImageIcon(imageScaled);
        gambarSoal.setIcon(settingsImage);
    }//GEN-LAST:event_btnCariGambarMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminTebakGambar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel btnCariGambar;
    ...
    private javax.swing.JTable tabelTebakGambar;
